...
const products = [
  { id: 'PROD01', name: 'Certified Maize Seeds (Longe 5)', supplier: 'Jaipur Seed Co.', category: 'Seeds', price: '15/-', stock: 500, status: 'Active', image: null },
  { id: 'PROD02', name: 'NPK 17-17-17 Fertilizer', supplier: 'Agro Inputs Ltd.', category: 'Fertilizers', price: '180/-', stock: 250, status: 'Active', image: null },
  { id: 'PROD03', name: 'Organic Pesticide (Neem Oil)', supplier: 'FarmCare Supplies', category: 'Agrochemicals', price: '45/-', stock: 100, status: 'Inactive', image: null },
  { id: 'PROD04', name: 'Urea Fertilizer', supplier: 'Agro Inputs Ltd.', category: 'Fertilizers', price: '150/-', stock: 300, status: 'Active', image: null },
];

const farmerProduce = [
    { id: 'PROD-F01', name: 'Fresh Maize (100kg)', farmer: 'John Mubiru', category: 'Grains', price: '110/-', status: 'Pending Review' },
    { id: 'PROD-F02', name: 'Robusta Coffee Beans (Grade A)', farmer: 'Aisha Nakato', category: 'Cash Crops', price: '8,500 /kg', status: 'Active' },
    { id: 'PROD-F03', name: 'Banana (Large Bunch)', farmer: 'Peter Okello', category: 'Staples', price: '25/-', status: 'Pending Review' },
];

type Supplier = (typeof suppliers)[number];
type InputProduct = (typeof products)[number];
type FarmerProduce = (typeof farmerProduce)[number];
...
export default function SupplierManagementPage() {
    ...
    const [selectedProduct, setSelectedProduct] = useState<InputProduct | FarmerProduce | null>(null);
    ...
    const openProductModal = (product: InputProduct | null = null) => {
        setSelectedProduct(product);
        setIsProductModalOpen(true);
    };

    const openDecisionModal = (product: FarmerProduce, decision: 'approve' | 'reject') => {
        setSelectedProduct(product);
    ...
    const handleDecision = () => {
        toast({
            ...
            description: `${selectedProduct?.name ?? 'Selected product'} has been ${decision === 'approve' ? 'made active' : 'rejected'}.`
        });
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="p-supplier">Supplier</Label>
                             <Select defaultValue={selectedProduct && 'supplier' in selectedProduct ? selectedProduct.supplier : undefined}>
                                <SelectTrigger>
